...
public class DesfireActivity extends Activity {
    ...
    private AlertDialog appAlertDialog;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        appAlertDialog = new AlertDialog.Builder(this).setView(dAppLv).create();
    ...
    private int authenticate(boolean isAuthen,byte keyNo,AuthenTypeEnum authenType,byte[] authenKey){
        ...
        if(isAuthen == false){
            ...
            if (authenType == AuthenTypeEnum.AuthenMode) {
            ...
            } else if (authenType == AuthenTypeEnum.ISOMode) {
            ...
            } else if (authenType == AuthenTypeEnum.AESMode) {
        ...
        cardReader.searchCard(slotTypes, 60, new OnCardInfoListener() {
            ...
            public void onCardInfo(int retCode, CardInfoEntity cardInfo) {
                    ...
                    if (cardInfo.getCardExistslot() == CardSlotTypeEnum.RF
                        ...
                        authenticate(true,piccKeyNo, AuthenTypeEnum.AuthenMode,defaultKey);
                        ...
                        if ((keySetting & 0x01) == 0x01) {
                            ...
                            authenticate(true,piccKeyNo, AuthenTypeEnum.AESMode,defaultAesKey);
            ...
            public void onCardInfo(int retCode, CardInfoEntity cardInfo) {
                if (cardInfo != null) {
                    ...
                    if (cardInfo.getCardExistslot() == CardSlotTypeEnum.RF
                        ...
                        authenticate(isCdAppAuth,piccKeyNo, AuthenTypeEnum.AuthenMode,defaultKey);
                        ...
                        authenticate(isAppDirAuth,piccKeyNo, AuthenTypeEnum.AuthenMode,defaultKey);
                                    ...
                                    SimpleAdapter adapter = new SimpleAdapter(DesfireActivity.this,
                                            ...
                                            applv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                                ...
                                                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                                    ...
                                                    if(0 != authenticate(true,appkeyNo, AuthenTypeEnum.ISOMode,defaultAppKey)) {
                                                        if(0 != authenticate(true,appkeyNo, AuthenTypeEnum.AuthenMode,defaultKey)){
                                                            return;
                                                        }
                                                    }
                                                    ...
                                                    if ((keySetting & 0x01) == 0x01) {//whether the application master key is changeable
                                                        if(0 != authenticate(true,specKeyNo, AuthenTypeEnum.ISOMode,defaultAppKey)) return;
                                                        ...
                                                        if(0 == ret) {
                                                            authenticate(true, appkeyNo, AuthenTypeEnum.ISOMode, defaultIsokey);
                                                            ...
                                                            authenticate(true, appkeyNo, AuthenTypeEnum.AuthenMode, defaultAppKey);
                                                        }
                                                    }
            ...
            public void onCardInfo(int retCode, CardInfoEntity cardInfo) {
                if (cardInfo != null) {
                    ...
                    if (cardInfo.getCardExistslot() == CardSlotTypeEnum.RF
                        ...
                        //Authentication
                        if(0 != authenticate(true,piccKeyNo, AuthenTypeEnum.AuthenMode,defaultKey));
                        Log.d(TAG, "getFreeMemory(): " + desfireHandler.getFreeMemory());
                        ...
                        if(0 != authenticate(isCdFileAuth,keyNo, AuthenTypeEnum.ISOMode,defaultAppKey)) {
                            if(0 != authenticate(isCdFileAuth,keyNo, AuthenTypeEnum.AuthenMode,defaultKey)){
...
//                        if(0 != authenticate(isCdFileAuth,keyNo,AuthenMode,defaultAppKey)) return;
                        ...
                        //Get file ID
                        if(0 != authenticate(isFileDirAuth,keyNo, AuthenTypeEnum.AuthenMode,defaultAppKey)) return;
...
//                dataFile.getFileSize());
        ...
        if(0 == ret) {
            authenticate(true,dataFile.getWriteAccessRightKeyNum(), AuthenTypeEnum.ISOMode,defaultAppKey);
            ...
            authenticate(true,dataFile.getReadAccessRightKeyNum(), AuthenTypeEnum.ISOMode,defaultAppKey);
    ...
    private void PerformValueFile(byte fileNo){
        ...
        if(ret == 0){
            ...
            if(0 != authenticate(true,valueFile.getReadAccessRightKeyNum(), AuthenTypeEnum.ISOMode,defaultAppKey)) return;
            ...
            int value = 1;
            if(0 != authenticate(true,valueFile.getWriteAccessRightKeyNum(), AuthenTypeEnum.ISOMode,defaultAppKey)) return;
...
//            Toast.makeText(DesfireActivity.this, "limitedCredit " + value + "; " + ret, Toast.LENGTH_SHORT).show();
            ...
            value = 1048;
            if(0 != authenticate(true,valueFile.getReadAndWriteAccessRightKeyNum(), AuthenTypeEnum.ISOMode,defaultAppKey)) return;
            ...
            //Read the currently stored value from Value Files.
            if(0 != authenticate(true,valueFile.getReadAndWriteAccessRightKeyNum(), AuthenTypeEnum.ISOMode,defaultAppKey));
            ret = desfireHandler.getValue(fileNo,valueFile.getCommSettings());
            Toast.makeText(DesfireActivity.this, "getValue : " + ret, Toast.LENGTH_SHORT).show();
    ...
    private void PerformRecordFile(byte fileNo,boolean isLinearFile){
        ...
        if(0 == ret){
            if(0 !=authenticate(true,recordFile.getWriteAccessRightKeyNum(), AuthenTypeEnum.ISOMode,defaultAppKey)) return;
            ...
            if(0 !=authenticate(true,recordFile.getReadAccessRightKeyNum(), AuthenTypeEnum.ISOMode,defaultAppKey)) return;
...
//                        authenticate(isAppDirAuth,keyNo,AuthenMode,defaultAppKey);
                        ...
                        //data manipulation
                        authenticate(isCdFileAuth,keyNo, AuthenTypeEnum.AuthenMode,defaultAppKey);
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {

...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customDeviceEngine = ((NexgoApplication) getApplication()).getCustomDeviceEngine();
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.beeper) {
            ...
            serialportTest();
        } else if (id == R.id.Cpucard) {
            cpucardTest();
        } else if (id == R.id.cardReader) {
            cardReaderTest();
        } else if (id == R.id.M1Card) {
            MifareCardTest();
        } else if (id == R.id.pinpad) {
            ...
            devInfoTest();
        } else if (id == R.id.memorycard) {
            MemoryCardTest();
        } else if (id == R.id.desfire) {
            startActivity(new Intent(this, DesfireActivity.class));
        } else if (id == R.id.Ultralight) {
            UltralightCardTest();
        } else if (id == R.id.PSAM) {
            testPsamCard();
        } else if (id == R.id.Platform) {
            startActivity(new Intent(this, PlatformActivity.class));
        } else if (id == R.id.MDBLed) {
            mdbLedTest();
        } else if (id == R.id.MDBSerial) {
            testMdbSerial();
        } else if (id == R.id.Iso8583) {
            testIso8583();
        } else if (id == R.id.SPDH) {
            testSpdh();
        }
    }
                ...
                switch (position) {
                    ...
                    case 2:
                        Observable.interval(70, TimeUnit.MILLISECONDS)
                                .observeOn(Schedulers.io())
                                .takeUntil((Predicate<? super Long>) aLong -> aLong == 1)
    ...
    private void serialportTest() {
        int portNum = 0;
        if (customDeviceEngine.getDeviceInfo().getModel().equalsIgnoreCase("UN20")) {
            portNum = 1; //UN20 can use port 1 or 2, depends on which Physical serial port insert
        } else if (customDeviceEngine.getDeviceInfo().getModel().equalsIgnoreCase("N86")) {
            portNum = 101;
        }

        final SerialPortDriver port = customDeviceEngine.getSerialPortDriver(portNum);
